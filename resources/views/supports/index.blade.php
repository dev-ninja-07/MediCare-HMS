    ...
    <div class="container-fluid">
        ...
        <aside class="page-aside">
            <div class="aside-content">
                ...
                <div class="aside-nav collapse">
                    <ul class="nav">
                        <li class="active"><a href="{{ route('supports.index') }}"><span class="icon"><i
                                        class="fas fa-fw fa-inbox"></i></span>Anonemus Inbox<span
                                    class="badge badge-primary float-right">{{ $supports->whereNull('user_id')->count() }}</span></a>
                        </li>
                        <li><a href="{{ route('supports.usermessages') }}"><span class="icon"><i
                                        class="fas fa-fw fa-inbox"></i></span>Users Inbox<span
                                    class="badge badge-primary float-right">{{ $supports->whereNotNull('user_id')->count() }}</span></a>
                        </li>
                    </ul><span class="title">Labels</span>

                    <div class="aside-compose"><a class="btn btn-lg btn-primary btn-block" href="#">Compose Email</a>
                    </div>
                </div>
            </div>
        </aside>
        ...
        <div class="main-content container-fluid p-0">
            ...
            <div class="email-inbox-header">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="email-title"><span class="icon"><i class="fas fa-inbox"></i></span> All Inbox <span
                                class="new-messages">({{ $supports->count() }} new messages)</span> </div>
                    </div>
                    <div class="col-lg-6">
            ...
            <div class="email-filters">
                <div class="email-filters-left">
                    ...
                    <div class="btn-group">
                        <button class="btn btn-light dropdown-toggle" data-toggle="dropdown" type="button">Order by <span
                                class="caret"></span></button>
                        <div class="dropdown-menu dropdown-menu-right" role="menu"><a class="dropdown-item"
                                href="#">Date</a><a class="dropdown-item" href="#">From</a><a
