<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" href="{{ route('specialization.index') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                            <path
                                d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 7h3V7h-3V5h5v13H8V5h4v5z"
                                opacity=".3" />
                            <path
                                d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V5h14v14zm-4-4h-4v-2h4v2zm0-4h-4v-2h4v2z" />
                        </svg>
                        <span class="side-menu__label">{{ __('Specializations') }}</span></a>
                </li>
            @endhasrole
            <li class="side-item side-item-category">{{ __('Management') }}</li>
            @hasrole('accountant|super-admin')
                <li class="slide">
            ...
            @endhasrole
            @hasrole('receptionist|accountant|super-admin')
                <li class="slide">
            ...
            @endhasrole
            @hasrole('doctor|nurse|super-admin')
                <li class="slide">
            ...
            @endhasrole
            @hasrole('receptionist|nurse|super-admin')
                <li class="slide">
            ...
            @hasrole('lab_technician|super-admin')
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">{{ __('Lab Management') }}</span>
                        @if (isset($labTests) && $labTests->where('doctor', '!=', null)->where('status', 'pending')->count() > 0)
                            <span class="mx-2 badge bg-primary text-white rounded-pill float-end">
                                {{ $labTests->where('doctor', '!=', null)->where('status', 'pending')->count() }}
                            </span>
                        @endif
                        <i class="angle fe fe-chevron-down"></i>
                    </a>
                    <ul class="slide-menu">
                        <li><a class="slide-item" href="{{ route('lab-test.index') }}">{{ __('Lab Tests') }}</a>
                        </li>
