        ...
        <div class="panel-body tabs-menu-body latest-tasks p-0 border-0">
            <div class="tabs-menu">
                <ul class="nav panel-tabs">
                    <li class="{{ Route::is('dashboard') ? 'd-block' : 'd-none' }}">
                        <a href="#side1" class="active" data-toggle="tab">
                            <i class="ion ion-md-chatboxes tx-18 mr-2"></i>
                            {{ __('Chat') }}
                        </a>
                    </li>
                    <li>
                        <a href="#side2" data-toggle="tab">
                            <i class="ion ion-md-notifications tx-18  mr-2"></i>
                            {{ __('Notifications') }}
                        </a>
                    </li>
                    <li class="{{ Route::is('dashboard') ? 'd-block' : 'd-none' }}">
                        <a href="#side3" data-toggle="tab">
                            <i class="ion ion-md-contacts tx-18 mr-2"></i>
                            {{ __('Friends') }}
                        </a>
                    </li>
                </ul>
                        ...
                        <div class="list-group list-group-flush">
                            @forelse($users as $user)
                                <div class="list-group-item d-flex align-items-center">
                                    ...
                                    <div class="ml-auto">
                                        <a href="{{ route('chatify', ['id' => $user->id]) }}"
